...
init: function() {
	...
	if(readability.getInnerText(articleContent, false).length < 250)
	{
		if (readability.flagIsActive(readability.FLAG_STRIP_UNLIKELYS)) {
			...
			articleContent.innerHTML = "<p>Sorry, the InfoNgen text extraction algorithm was unable to parse this page for content.</p><p>Also, please note that the InfoNgen text extraction algorithm does not play very nicely with front pages. InfoNgen text extraction algorithm is designed to work on articles with a sizable chunk of article text. If you're using InfoNgen on a landing page (like nytimes.com for example), please click into an article link first.</p>";
		}
	}
