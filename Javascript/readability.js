...
var readability = {
    ...
    prepDocument: function () {
        ...
        if(frames.length > 0)
        {
            ...
            if(bestFrame)
            {
                readability.bodyElement.innerHTML=bestFrame.contentWindow.document.body.innerHTML;
        ...
        var scripts = readability.bodyElement.getElementsByTagName('script');
        ...
        var styleTags = readability.bodyElement.getElementsByTagName("style");
        ...
        readability.bodyElement.innerHTML = readability.bodyElement.innerHTML.replace(readability.regexps.replaceBrsRe, '</p><p>').replace(readability.regexps.replaceFontsRe, '<$1span>');
    },
    ...
    **/
    grabArticle: function () {
        ...
        **/
        var node = null;
		var nodesToScore = [];
        for(var nodeIndex = 0; (node = readability.bodyElement.getElementsByTagName('*')[nodeIndex]); nodeIndex++)
        {
        ...
        **/
        ...
        if (topCandidate === null || topCandidate.tagName == "BODY")
        {
            ...
            topCandidate.innerHTML = readability.bodyElement.innerHTML; //document.body.innerHTML;
            readability.bodyElement.innerHTML="";
			readability.bodyElement.appendChild(topCandidate);
